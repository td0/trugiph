...
jest.mock('@/components/VirtualizedMasonryGrid', () => ({
  VirtualizedMasonryGrid: ({ items, onLoadMore, hasNextPage, isLoading }: {
    items: MasonryItem[];
    onLoadMore: () => void;
    hasNextPage: boolean;
    isLoading: boolean;
...
const mockUseSearchGifs = useSearchGifs as jest.MockedFunction<typeof useSearchGifs>;
const mockTransformGiphyArrayToMasonryItems = transformGiphyArrayToMasonryItems as jest.MockedFunction<
...
describe('SearchPage', () => {
  ...
  describe('Loading State', () => {
    ...
    it('displays the search keyword in loading message', () => {
      ...
      expect(screen.getByText('Searching for "funny dogs"...')).toBeInTheDocument();
    });
  });
  ...
  describe('Empty Results', () => {
    it('shows empty state when no results found', () => {
      ...
      expect(screen.getByText('No GIFs found for "nonexistent"')).toBeInTheDocument();
  ...
  describe('Results Display', () => {
    const mockItems = [
      { id: '1', imageUrl: 'gif1.gif', staticImageUrl: 'gif1_s.gif', width: 200, height: 150, title: 'GIF 1' },
      { id: '2', imageUrl: 'gif2.gif', staticImageUrl: 'gif2_s.gif', width: 180, height: 200, title: 'GIF 2' },
    ];
    ...
    it('shows scroll hint when results are available', () => {
      ...
      expect(screen.getByText('💡 Scroll down to load more search results')).toBeInTheDocument();
    });
    ...
    it('does not show scroll hint when no results', () => {
      ...
      expect(screen.queryByText('💡 Scroll down to load more search results')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Infinite Scrolling', () => {
    it('passes correct props to masonry grid', () => {
      ...
      const mockItems = [
        { id: '1', src: 'gif1.gif', srcStatic: 'gif1_s.gif', alt: 'GIF 1', width: '200px', height: '150px' },
      ];
  ...
  describe('Data Transformation', () => {
    it('transforms multiple pages of data correctly', () => {
      ...
      const mockItems = [
        { id: '1', imageUrl: 'gif1.gif', staticImageUrl: 'gif1_s.gif', width: 200, height: 150, title: 'GIF 1' },
        { id: '2', imageUrl: 'gif2.gif', staticImageUrl: 'gif2_s.gif', width: 180, height: 200, title: 'GIF 2' },
        { id: '3', imageUrl: 'gif3.gif', staticImageUrl: 'gif3_s.gif', width: 220, height: 180, title: 'GIF 3' },
        { id: '4', imageUrl: 'gif4.gif', staticImageUrl: 'gif4_s.gif', width: 190, height: 160, title: 'GIF 4' },
      ];
  ...
  describe('Hook Integration', () => {
    ...
    it('calls useSearchGifs with decoded keyword', () => {
      ...
      expect(mockUseSearchGifs).toHaveBeenCalledWith('funny dogs', { limit: 25 });
    });
  });
});
